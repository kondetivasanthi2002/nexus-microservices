import { EmailTemplateServiceHandler, EmailTemplateDomainEntity } from './modules/emailTemplate';

describe('NOTIFICATION Microservice Test Suite', () => {
  let handler: EmailTemplateServiceHandler;

  beforeEach(() => {
    handler = new EmailTemplateServiceHandler();
  });
