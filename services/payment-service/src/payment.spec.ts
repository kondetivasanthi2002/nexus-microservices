import { TransactionLedgerServiceHandler, TransactionLedgerDomainEntity } from './modules/transactionLedger';

describe('PAYMENT Microservice Test Suite', () => {
  let handler: TransactionLedgerServiceHandler;

  beforeEach(() => {
    handler = new TransactionLedgerServiceHandler();
  });
