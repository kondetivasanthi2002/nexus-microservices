import { OrderHeaderServiceHandler, OrderHeaderDomainEntity } from './modules/orderHeader';

describe('ORDER Microservice Test Suite', () => {
  let handler: OrderHeaderServiceHandler;

  beforeEach(() => {
    handler = new OrderHeaderServiceHandler();
  });
