import { MetricAggregationServiceHandler, MetricAggregationDomainEntity } from './modules/metricAggregation';

describe('ANALYTICS Microservice Test Suite', () => {
  let handler: MetricAggregationServiceHandler;

  beforeEach(() => {
    handler = new MetricAggregationServiceHandler();
  });
