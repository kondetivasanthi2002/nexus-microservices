import { UserAccountServiceHandler, UserAccountDomainEntity } from './modules/userAccount';

describe('AUTH Microservice Test Suite', () => {
  let handler: UserAccountServiceHandler;

  beforeEach(() => {
    handler = new UserAccountServiceHandler();
  });
