import { ProductMasterServiceHandler, ProductMasterDomainEntity } from './modules/productMaster';

describe('CATALOG Microservice Test Suite', () => {
  let handler: ProductMasterServiceHandler;

  beforeEach(() => {
    handler = new ProductMasterServiceHandler();
  });
